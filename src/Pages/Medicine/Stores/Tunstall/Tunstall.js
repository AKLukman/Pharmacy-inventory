...
const Tunstall = () => {
  ...
  const handleCheckId = (data) => {
    ...
    if (date && users?.store === "tunstall" && age > 17) {
      console.log("success");
      navigate("/tunstall-store-id-check");
      ...
      setStore("");
      reset();
    } else if (date && users?.store === "tunstall" && age < 18) {
      ...
      setStore("");
      reset();
    } else if (date && users?.store !== "tunstall") {
    ...
    <div>
      ...
      <div className="h-[500px] flex justify-center items-center">
        <div>
          ...
          <Link to={"/tunstall-store-not-id-check"}>
