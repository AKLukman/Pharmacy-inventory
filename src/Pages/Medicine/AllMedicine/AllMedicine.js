...
const AllMedicine = () => {
  ...
  return (
    <div className="ml-10">
      ...
      <h2 className="text-center font-bold text-2xl mt-8">All Medicine</h2>

      <h2 className="text-center">
        {medicine.length === 0 && "No Records Found"}
      </h2>
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 mb-40">
        {medicine.map((medicine) => (
          <Medi medicine={medicine} key={medicine._id}></Medi>
        ))}
      </div>
      <div
