...
const FentonMedicineDetails = () => {
  ...
  const handleCheckId = (data) => {
    ...
    if (date && user?.store === "fenton" && age > 17) {
      console.log("success");
      ...
      setUserRegisterd("");
      reset();
    } else if (date && user?.store === "fenton" && age < 18) {
      ...
      setUserRegisterd("");
      reset();
    } else if (date && user?.store !== "fenton") {
    ...
    <div>
      ...
      <div className="mb-4">
        ...
        <p>
          ...
          <span className="font-bold"> {medicine.availabilityFenton}</span>
        </p>
      </div>
      <div class="w-1/3">
...
export default FentonMedicineDetails;
