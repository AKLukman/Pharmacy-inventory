      ...
      <div ref={contentRef}>
        <div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          <div class="border-t-2 border-b-2 py-4 mb-8">
            ...
            <p class="text-sm text-center mt-2">Stoke Store</p>
          </div>
            ...
            <table class="w-full mt-4">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="text-right">£{medicine.price * quantity}</td>
                </tr>
              </tbody>
            </table>
          </div>
    ...
    <div>
      ...
      <div className="mb-4">
        ...
        <p>
          ...
          <span className="font-bold"> {medicine.availabilityStoke}</span>
        </p>
      </div>
      <div class="w-1/3">
...
export default StokeMedicineDetails;
